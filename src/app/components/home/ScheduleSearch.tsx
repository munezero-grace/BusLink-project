    ...
    <section className="w-full max-w-4xl mx-auto -mt-16 relative z-20 bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="w-full md:w-1/5">
          ...
          <select id="route-day" className="w-full border border-gray-300 rounded-md px-3 py-2">
      ...
      <div className="mt-4 flex">
        <Link 
          href="/tracking" 
          className="bg-blue-500 text-white text-sm px-4 py-2 rounded-l-md"
        >
          All timetables and maps
        </Link>
        <Link 
          href="/schedules" 
          className="bg-white text-blue-500 border border-blue-500 text-sm px-4 py-2 rounded-r-md flex items-center gap-1"
        >
